...
ftp = FTP('ftp://ftp.ebi.ac.uk/pub/databases/chembl/ChEMBLdb/releases/chembl_23')
ftp.set_local_dir('data/ChEMBL/ChEMBLdb/23')
...
ftp.download('chembl_23.fa.gz')
ftp.download('chembl_23.fps.gz')
ftp.download('chembl_23.sdf.gz')
ftp.download('chembl_23_bio.fa.gz')
ftp.download('chembl_23_chemreps.txt.gz')
ftp.download('chembl_23_monomer_library.xml', mode='text')
ftp.download('chembl_23_release_notes.txt', mode='text')
ftp.download('chembl_23_schema.png')
ftp.download('chembl_23_sqlite.tar.gz')
ftp.download('chembl_uniprot_mapping.txt', mode='text')
ftp.download('schema_documentation.html', mode='text')
ftp.download('schema_documentation.txt', mode='text')

ftp = FTP('ftp://ftp.ebi.ac.uk/pub/databases/chembl/ChEMBLdb/releases/chembl_24_1')
...
ftp.download('chembl_24_1_sqlite.tar.gz')
ftp.download('chembl_uniprot_mapping.txt', mode='text')

ftp = FTP('ftp://ftp.ebi.ac.uk/pub/databases/chembl/ChEMBLdb/releases/chembl_25')
ftp.set_local_dir('data/ChEMBL/ChEMBLdb/25')
ftp.download('LICENSE', mode='text')
ftp.download('README', mode='text')
ftp.download('REQUIRED.ATTRIBUTION', mode='text')
ftp.download('checksums.txt', mode='text')
ftp.download('chembl_25.fa.gz')
ftp.download('chembl_25.fps.gz')
ftp.download('chembl_25.sdf.gz')
ftp.download('chembl_25_bio.fa.gz')
ftp.download('chembl_25_chemreps.txt.gz')
ftp.download('chembl_25_monomer_library.xml', mode='text')
ftp.download('chembl_25_release_notes.txt', mode='text')
ftp.download('chembl_25_schema.png')
ftp.download('chembl_25_schema_documentation.html', mode='text')
ftp.download('chembl_25_schema_documentation.txt', mode='text')
ftp.download('chembl_25_sqlite.tar.gz')
ftp.download('chembl_uniprot_mapping.txt', mode='text')

ftp = FTP('ftp://ftp.ebi.ac.uk/pub/databases/chembl/GPCRSARfari/releases/3.00')
...
ftp = FTP('ftp://ftp.ebi.ac.uk/pub/databases/chembl/KinaseSARfari/releases/5.01')
...
ftp = FTP('ftp://ftp.ebi.ac.uk/pub/databases/chembl/MalariaData/releases/mmv_3')
...
ftp = FTP('ftp://ftp.ebi.ac.uk/pub/databases/chembl/SureChEMBL/data')
